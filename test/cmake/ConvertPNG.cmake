...
execute_process(
    COMMAND ${IMAGEMAGICK_COMMAND} -define png:bit-depth=8 -define png:exclude-chunk=gAMA ${IN_FILE} ${CMAKE_CURRENT_LIST_DIR}/temp.png
    ERROR_QUIET
)
if (EXISTS ${CMAKE_CURRENT_LIST_DIR}/temp.png)
    execute_process(COMMAND ${IMAGEMAGICK_COMMAND} -intensity Average ${CMAKE_CURRENT_LIST_DIR}/temp.png ${OUT_FILE})
