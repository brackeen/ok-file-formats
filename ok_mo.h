...
/**
 * Gets the value for the specified context and key. If there is no value for the key, the key is 
 * returned.
 */
...
/**
 * Gets the value for the specified context and key. If there is no value for the key, the key is 
 * returned. If there are plural variants, returns the plural variant for the specified n value.
 */
